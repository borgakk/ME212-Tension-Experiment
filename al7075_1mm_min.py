...
file_path = "C:/Users/borga/OneDrive/Desktop/malzeme lablar/lab2/al7075_1mm_min.TRA"
...
plt.title('al7075_1mm_min')
plt.grid(True)

yield_strength_eng = 445
fracture_strength_eng = 496
fracture_strength_true = 537
...
plt.scatter(0.0053, yield_strength_eng, color='red', label='Yield Strength 445Mpa', zorder=5)
plt.scatter(0.054, ultimate_strength_eng, color='green', label='Ultimate Tensile Strength (Engineering) 522MPa', zorder=5)
...
plt.scatter(0.06, ultimate_strength_true, color='purple', label='Ultimate Tensile Strength (True) 553MPa', zorder=5)
plt.scatter(np.max(true_strain), fracture_strength_true, color='cyan', label='Fracture Strength (True) 537MPa', zorder=5)
