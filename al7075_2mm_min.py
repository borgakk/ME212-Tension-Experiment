...
file_path = "C:/Users/borga/OneDrive/Desktop/malzeme lablar/lab2/al7075_2mm_min.TRA"
...
plt.title('al7075_2mm_min')
plt.grid(True)

yield_strength_eng = 448
fracture_strength_eng = 496
fracture_strength_true = 539
modulus_of_elasticity = yield_strength_eng/0.0053
...
plt.scatter(0.0053, yield_strength_eng, color='red', label='Yield Strength 448Mpa', zorder=5)
plt.scatter(0.055, ultimate_strength_eng, color='green', label='Ultimate Tensile Strength (Engineering) 522MPa', zorder=5)
plt.scatter(np.max(engineering_strain), fracture_strength_eng, color='blue', label='Fracture Strength (Engineering) 496MPa', zorder=5)


plt.scatter(0.061, ultimate_strength_true, color='purple', label='Ultimate Tensile Strength (True) 554MPa', zorder=5)
plt.scatter(np.max(true_strain), fracture_strength_true, color='cyan', label='Fracture Strength (True) 539MPa', zorder=5)
