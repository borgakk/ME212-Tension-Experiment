...
file_path = "C:/Users/borga/OneDrive/Desktop/malzeme lablar/lab2/steel1010_1mm_min.TRA"
...
plt.title('steel1010_1mm_min')
plt.grid(True)

yield_strength_eng = 172
fracture_strength_eng = 200
fracture_strength_true = 260
modulus_of_elasticity = yield_strength_eng/0.0015
...
plt.scatter(0.0015, yield_strength_eng, color='red', label='Yield Strength 172Mpa', zorder=5)
plt.scatter(0.16, ultimate_strength_eng, color='green', label='Ultimate Tensile Strength (Engineering) 249MPa', zorder=5)
plt.scatter(np.max(engineering_strain), fracture_strength_eng, color='blue', label='Fracture Strength (Engineering) 200MPa', zorder=5)


plt.scatter(0.21, ultimate_strength_true, color='purple', label='Ultimate Tensile Strength (True) 301MPa', zorder=5)
plt.scatter(np.max(true_strain), fracture_strength_true, color='cyan', label='Fracture Strength (True) 260MPa', zorder=5)
