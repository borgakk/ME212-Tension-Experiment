...
file_path = "C:/Users/borga/OneDrive/Desktop/malzeme lablar/lab2/steel1040_2mm_min.TRA"
...
plt.title('steel1040_2mm_min')
plt.grid(True)

yield_strength_eng = 477
fracture_strength_eng = 708
fracture_strength_true = 755
modulus_of_elasticity = yield_strength_eng/0.0021
...
plt.scatter(0.0021, yield_strength_eng, color='red', label='Yield Strength 477Mpa', zorder=5)
plt.scatter(0.024, ultimate_strength_eng, color='green', label='Ultimate Tensile Strength (Engineering) 744MPa', zorder=5)
plt.scatter(np.max(engineering_strain), fracture_strength_eng, color='blue', label='Fracture Strength (Engineering) 708MPa', zorder=5)


plt.scatter(0.036, ultimate_strength_true, color='purple', label='Ultimate Tensile Strength (True) 767MPa', zorder=5)
plt.scatter(np.max(true_strain), fracture_strength_true, color='cyan', label='Fracture Strength (True) 755MPa', zorder=5)
