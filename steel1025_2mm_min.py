...
file_path = "C:/Users/borga/OneDrive/Desktop/malzeme lablar/lab2/steel1025_2mm_min.TRA"
...
plt.title('steel1025_2mm_min')
plt.grid(True)

yield_strength_eng = 558
fracture_strength_eng = 580
fracture_strength_true = 628
...
plt.scatter(0.0024, yield_strength_eng, color='red', label='Yield Strength 558Mpa', zorder=5)
plt.scatter(0.044, ultimate_strength_eng, color='green', label='Ultimate Tensile Strength (Engineering) 611MPa', zorder=5)
plt.scatter(np.max(engineering_strain), fracture_strength_eng, color='blue', label='Fracture Strength (Engineering) 580MPa', zorder=5)


plt.scatter(0.057, ultimate_strength_true, color='purple', label='Ultimate Tensile Strength (True) 644MPa', zorder=5)
plt.scatter(np.max(true_strain), fracture_strength_true, color='cyan', label='Fracture Strength (True) 628MPa', zorder=5)
