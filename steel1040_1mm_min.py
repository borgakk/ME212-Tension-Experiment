...
file_path = "C:/Users/borga/OneDrive/Desktop/malzeme lablar/lab2/steel1040_1mm_min.TRA"
...
plt.title('steel1040_1mm_min')
plt.grid(True)

yield_strength_eng = 477
fracture_strength_eng = 725
fracture_strength_true = 776
modulus_of_elasticity = yield_strength_eng/0.0019
...
plt.scatter(0.0019, yield_strength_eng, color='red', label='Yield Strength 477Mpa', zorder=5)
plt.scatter(0.024, ultimate_strength_eng, color='green', label='Ultimate Tensile Strength (Engineering) 763MPa', zorder=5)
plt.scatter(np.max(engineering_strain), fracture_strength_eng, color='blue', label='Fracture Strength (Engineering) 725MPa', zorder=5)


plt.scatter(0.039, ultimate_strength_true, color='purple', label='Ultimate Tensile Strength (True) 787MPa', zorder=5)
plt.scatter(np.max(true_strain), fracture_strength_true, color='cyan', label='Fracture Strength (True) 776MPa', zorder=5)
